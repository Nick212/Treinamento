              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p><asp:Button ID="btnHospedar" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
            ...
            <!--AP 02-->
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p><asp:Button ID="Button1" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    <center>
                      ...
                      <!--<p><a href='<%=ResolveUrl("~/View/Hospedagem/Calendario.aspx")%>' class="btn btn-primary" role="button">Button</a>-->
                    <p><asp:Button ID="Button2" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
            ...
            <!--AP 04-->
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <!--<p><a href='<%=ResolveUrl("~/View/Hospedagem/Calendario.aspx")%>' class="btn btn-primary" role="button">Button</a>-->
                    <p><asp:Button ID="Button3" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
            ...
            <!--AP 05-->
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <!--<p><a href='<%=ResolveUrl("~/View/Hospedagem/Calendario.aspx")%>' class="btn btn-primary" role="button">Button</a>-->
                    <p><asp:Button ID="Button4" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
                ...
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    <center>
                      ...
                      <!--<p><a href='<%=ResolveUrl("~/View/Hospedagem/Calendario.aspx")%>' class="btn btn-primary" role="button">Button</a>-->
                    <p><asp:Button ID="Button5" runat="server" Text="Hospedar" Font-Bold="true" CssClass="btn btn-block btn-default" OnClick="btnHospedar_Click" /></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <asp:Panel ID="ModalAlerta" runat="server" Style="width: 100%; height: 100%; position: fixed; background-color: rgba(0,0,0,0.5); left: 0; top: 0;" Visible="false">
            <asp:Panel ID="ModalBoxAlerta" runat="server" Style="width: 31%; height: 48%; position: absolute; background-color: #FFF; left: 50%; top: 50%; margin-left: -15%; margin-top: -15%; border-radius: 5px;">
                ...
                <div class="modal-body">
                    ...
                    <center><h1>Dados da Hospedagem</h1></center><hr />
