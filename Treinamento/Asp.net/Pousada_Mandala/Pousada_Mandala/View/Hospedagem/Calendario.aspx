        ...
        <div id="content" role="main" class="container-fluid dashboard-user-events">
            <div class="row">
                ...
                <aside class="col-md-3">
                    <a class="btn btn-block btn-primary" href="/events/new">Agendamento Prévio  <i class="glyphicon glyphicon-plus glyphicon-white"></i>
                    </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Para sincronizar o seu calendário com programas de agenda, você deve incluir este endereço:</p>
                                    <h4>http://aluno.impactaonline.com.br/events.ics?calendar_token=ahZtiQ9-dRLKQyCUyp6d</h4>
                                    <p>Por exemplo, no Google Agenda:</p>
                                    <ol>
                                        <li>Clicar em Outras agendas</li>
                                        <li>Adicionar por URL</li>
                                        <li>No campo URL, preencher:<br>
                                            http://aluno.impactaonline.com.br/events.ics?calendar_token=ahZtiQ9-dRLKQyCUyp6d</li>
                                        <li>Clicar em Adicionar agenda</li>
                                    </ol>
                                </div>
